...
describe('TttService', () => {
  ...
  describe('createRoom', () => {
    ...
    it('should throw an exception', () => {
      ...
      return service.createRoom(1234).then(() => expect(true).toBe(false))
        .catch(err => {
  ...
  describe('joinRoom', () => {
    ...
    it('should throw an exception as user is in a room', () => {
      ...
      return service.joinRoom(1, 1).then(() => expect(true).toBe(false))
        .catch(err => {
          expect(err).toBeInstanceOf(BadRequestException);
        });
    })
    ...
    it('should throw an exception as room does not exist', () => {
      ...
      return service.joinRoom(1, 2).then(() => expect(true).toBe(false))
        .catch(err => {
          expect(err).toBeInstanceOf(BadRequestException);
        });
    })
  ...
  describe('MakeMove', () => {
    it('should return a game that had x on index 1', () => {
      ...
      jest
        ...
        .mockResolvedValueOnce(x.currentGame);
      ...
      return service.MakeMove(1, 1, 1).then((game) => expect(game).toEqual(expected.currentGame));
    })
  ...
  describe('onDisconnect', () => {
    it('should return a game and disconnect p1', () => {
      ...
      return service.onDisconnect(1).then((room) => expect(room).toEqual(expected));
    })
    ...
    it('should return a game and disconnect p2', () => {
      ...
      return service.onDisconnect(2).then((room) => expect(room).toEqual(expected));
    })
  })
